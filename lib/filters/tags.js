...
exports['iframe'] = (comp) => {
    ...
    //HANDLE FACEBOOK IFRAMES
        ...
        if(typeof href !== 'string' || href === '' || !match.evaluateFor("ABSOLUTE_URI", href))
            ...
            html.setComponentAttribute(ampFacebook, 'width', (!width || match.evaluateFor('INVALID_DIMENSIONS',width)? RATIOS[defaultRatio].w : width));
            html.setComponentAttribute(ampFacebook, 'height', (!height || match.evaluateFor('INVALID_DIMENSIONS',height)? RATIOS[defaultRatio].h : height));
