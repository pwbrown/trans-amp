...
const html = require('../helpers/html'),
      ...
      runAttributeFilters = require('./runner').runAttributeFiltersOnComponent,
...
exports['input'] = (comp) => {
    ...
    if(type && PROHIBITED_INPUTS.indexOf(type) !== -1)
        return actions.preConfiguredAction("REMOVE");
    return runAttributeFilters(comp);
}
...
exports['img'] = (comp) => {
    ...
    var change = runAttributeFilters(ampImg);
    change.modify = true;
...
exports['video'] = (comp) => {
    ...
    var change = runAttributeFilters(ampVideo);
    change.modify = true;
...
exports['audio'] = (comp) => {
    ...
    var change = runAttributeFilters(ampAudio);
    change.modify = true;
